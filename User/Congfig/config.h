...
#define A_BOARD_TO_OTHER_BOARDS_ID 0x02AU
#define B_BOARD_TO_OTHER_BOARDS_ID 0x02BU
#define C_BOARD_TO_OTHER_BOARDS_ID 0x02CU
#define D_BOARD_TO_OTHER_BOARDS_ID 0x02DU

// 根据板子类型定义对应的ENCODER_ID
#ifdef AGV_BOARD_A
#define ENCODER_ID A_ENCODER_ID
#define AGV_BOARD_ID A_STEERING_CAN_ID          //c板向a轮组发送的控制信息
#define BOARD_TO_BOARDS_ID A_BOARD_TO_OTHER_BOARDS_ID  //a轮组向其他轮组发送信息的id
#define AGV_BOARD_CAN_DATA CAN2_0x02A_Tx_Data   //a轮组向其他轮组发送的信息
...
#define AGV_BOARD_CAN_DATA CAN2_0x02B_Tx_Data
#define BOARD_TO_BOARDS_ID B_BOARD_TO_OTHER_BOARDS_ID
...
#define AGV_BOARD_CAN_DATA CAN2_0x02C_Tx_Data
#define BOARD_TO_BOARDS_ID C_BOARD_TO_OTHER_BOARDS_ID
...
#define AGV_BOARD_CAN_DATA CAN2_0x02D_Tx_Data
#define BOARD_TO_BOARDS_ID D_BOARD_TO_OTHER_BOARDS_ID
